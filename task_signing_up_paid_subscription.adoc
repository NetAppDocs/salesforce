...
summary: Getting started with a paid subscription of SaaS Backup for Salesforce includes obtaining an activation code and signing up with Salesforce or a NetApp SSO.
---

= Signing up for a paid subscription of SaaS Backup for Salesforce
:toc: macro
:toclevels: 1
:hardbreaks:
:nofooter:
...
[.lead]
You can sign up for a paid subscription of SaaS Backup with Salesforce or with your NetApp SSO account.

To complete sign-up process, you must have the serial number supplied when you purchased your SaaS Backup license or the activation code supplied when you signed up for a free-trial version.
