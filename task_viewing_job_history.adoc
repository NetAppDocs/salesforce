...
summary: You can view a list of all jobs completed, canceled, or failed within SaaS Backup for Salesforce.
---
...
== Viewing job history
You can view a list of all jobs completed, canceled, or failed within SaaS Backup for Salesforce.
